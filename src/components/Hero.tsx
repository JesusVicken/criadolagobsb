...
const WHATS = "https://wa.me/5561992078620?text=Ol%C3%A1!%20Vi%20o%20site%20da%20Cria%20do%20Lago%20e%20quero%20conhecer%20as%20pe%C3%A7as%20%F0%9F%9A%A3";
    ...
    >
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-5 sm:px-8 pb-16 sm:pb-20 md:pb-28 pt-[45vh] sm:pt-[40vh] md:pt-[35vh]">
        ...
        <p className="text-[var(--cream)] text-base sm:text-lg md:text-xl font-light max-w-md mb-8 leading-relaxed opacity-95">
          De atleta, para atleta. Vestuário esportivo e casual que nasceu no Lago Paranoá.
        </p>

        {/* CTA Buttons */}
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 max-w-md sm:max-w-none">
          <a href="#colecao" className="btn-primary justify-center">
            <span>Ver Coleção de Roupas</span>
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" className="relative z-10 shrink-0">
              <path d="M2 7h10M8 3l4 4-4 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </a>
          <a href={WHATS} target="_blank" rel="noopener noreferrer" className="btn-secondary justify-center">
