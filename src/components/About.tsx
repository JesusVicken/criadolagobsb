...
export default function About() {
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8 flex flex-col gap-16">
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          {/* Left: Video + Image stack */}
          <div className="relative">
            <div className="relative aspect-[3/4] max-w-xs sm:max-w-sm mx-auto md:max-w-none overflow-hidden rounded-sm">
              {/* Decorative frames */}
        ...
        {/* Prominent, clean image showcase (hero-bg.png) - Taller height, clean photo without text overlay */}
        <div className="relative mt-4 overflow-hidden rounded-md border border-[var(--border)] glass">
          <div className="relative h-48 sm:h-64 md:h-80 w-full overflow-hidden">
            <Image
              src="/media/editadas/hero-bg.png"
              alt="Cria do Lago Lifestyle"
              fill
              className="object-cover object-center transition-transform duration-1000 hover:scale-105"
              sizes="100vw"
            />
            {/* Subtle gradient vignette */}
            <div className="absolute inset-0 bg-gradient-to-t from-[#080c10]/80 via-transparent to-[#080c10]/30 pointer-events-none" />
          </div>
        </div>
      </div>
    </section>
